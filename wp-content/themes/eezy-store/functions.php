	...
	if ( is_admin() ) {
		...
		<div id="profile-page" class="wrap">
			...
			<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
				...
				<a class="nav-tab<?php  if($importer_new==1 || $importer_new==''){ echo esc_attr( " active" ); }?>" href="?page=eezy_store_pro&amp;importer=demo-documentation&amp;active_class=1"><?php _e('Live Demo and Documentation','eezy-store'); ?></a>
				
				<a class="nav-tab<?php  if($importer_new==2){ echo esc_attr( " active" ); }?>" href="?page=eezy_store_pro&amp;importer=free-vs-pro&amp;active_class=2"><?php _e('Free Vs Pro','eezy-store'); ?></a>
				
				<a class="nav-tab<?php  if($importer_new==3){ echo esc_attr( " active" ); }?>" href="?page=eezy_store_pro&amp;importer=phoen-data-importer&amp;active_class=3"><?php _e('One Click Demo Import','eezy-store'); ?></a>
