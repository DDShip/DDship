...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header header2-site-header" role="banner">
		...
		<div class="site-branding">
			...
			<div class="col-sm-5 col-xs-6 login-sec">
				...
				<div class="basket-cart">
					...
					<?php  global $woocommerce; ?><a class="cart-contents" href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" title="<?php esc_attr_e('View your shopping cart', 'eezy-store'); ?>"> <span class="icon-basket-loaded"></span> <?php echo sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count, 'eezy-store'), $woocommerce->cart->cart_contents_count);?> <?php echo wp_kses_post($woocommerce->cart->get_cart_total()); ?></a>
